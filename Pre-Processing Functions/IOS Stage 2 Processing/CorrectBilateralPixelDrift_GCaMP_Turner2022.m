function [] = CorrectBilateralPixelDrift_GCaMP_Turner2022(procDataFileIDs)
...
[animalIDs,fileDates,~] = GetFileInfo_Turner2022(procDataFileIDs);
...
for b = 1:length(firstsFileOfDay)
    ...
    [~,fileDate,~] = GetFileInfo_Turner2022(fileName);
