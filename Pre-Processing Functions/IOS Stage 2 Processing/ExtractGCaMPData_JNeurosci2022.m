function [] = ExtractGCaMPData_JNeurosci2022(ROIs,ROInames,rawDataFileIDs,procDataFileIDs)
...
for a = 1:size(rawDataFileIDs,1)
    ...
    [animalID,fileDate,fileID] = GetFileInfo_JNeurosci2022(rawDataFileID);
    ...
    for b = 1:length(ROInames)
        ...
        if strcmp(ROIshortName,'LH') == true || strcmp(ROIshortName,'RH') == true
            ...
            close(maskFig)
            cbvMeanIntensity = BinToIntensity_JNeurosci2022(mask,cbvFrames);
            gcampMeanIntensity = BinToIntensity_JNeurosci2022(mask,gcampFrames);
            deoxyMeanIntensity = BinToIntensity_JNeurosci2022(mask,deoxyFrames);
        ...
        elseif strcmp(ROIshortName,'Cement') == true
            ...
            close(maskFig)
            cbvCementMeanIntensity = BinToIntensity_JNeurosci2022(mask,cbvFrames);
            gcampCementMeanIntensity = BinToIntensity_JNeurosci2022(mask,gcampFrames);
            deoxyCementMeanIntensity = BinToIntensity_JNeurosci2022(mask,deoxyFrames);
