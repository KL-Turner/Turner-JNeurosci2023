function [] = ProcessIntrinsicData_JNeurosci2023(animalID,imagingType,lensMag,rawDataFileIDs,procDataFileIDs)
...
[ROIs] = CheckROIDates_JNeurosci2023(animalID,ROIs,ROInames,imagingType,lensMag);
...
if strcmpi(imagingType,'GCaMP') == true
    ExtractGCaMPData_JNeurosci2023(ROIs,ROInames,rawDataFileIDs,procDataFileIDs)
else
    ExtractCBVData_JNeurosci2023(ROIs,ROInames,rawDataFileIDs)
end
...
for a = 1:size(procDataFileIDs,1)
    ...
    load(rawDataFileID)
    [~,fileDate,~] = GetFileInfo_JNeurosci2023(rawDataFileID);
    ...
    for b = 1:length(ROInames)
        ...
        CheckForNaNs_JNeurosci2023(ProcData,imagingType);
