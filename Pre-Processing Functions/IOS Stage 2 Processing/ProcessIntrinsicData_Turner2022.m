function [] = ProcessIntrinsicData_Turner2022(animalID,imagingType,lensMag,rawDataFileIDs,procDataFileIDs)
...
[ROIs] = CheckROIDates_Turner2022(animalID,ROIs,ROInames,imagingType,lensMag);
...
if strcmpi(imagingType,'GCaMP') == true
    ExtractGCaMPData_Turner2022(ROIs,ROInames,rawDataFileIDs,procDataFileIDs)
else
    ExtractCBVData_Turner2022(ROIs,ROInames,rawDataFileIDs)
end
...
for a = 1:size(procDataFileIDs,1)
    ...
    load(rawDataFileID)
    [~,fileDate,~] = GetFileInfo_Turner2022(rawDataFileID);
    ...
    for b = 1:length(ROInames)
        ...
        CheckForNaNs_Turner2022(ProcData,imagingType);
