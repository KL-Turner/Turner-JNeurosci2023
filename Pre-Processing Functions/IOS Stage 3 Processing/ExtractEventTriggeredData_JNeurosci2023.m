function [EventData] = ExtractEventTriggeredData_JNeurosci2023(procdataFiles,dataTypes,imagingType)
...
for a = 1:length(dataTypes)
    ...
    for b = 1:size(procdataFiles,1)
        ...
        [animal,fileDate,fileID] = GetFileInfo_JNeurosci2023(procdataFiles(b,:));
