function [figHandle,ax1,ax2,ax3,ax4,ax5,ax6] = GenerateSingleFigures_JNeurosci2023(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType,hemoType)
