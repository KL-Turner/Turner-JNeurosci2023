function [] = UpdateTotalHemoglobin_JNeurosci2023(procDataFileIDs,RestingBaselines,baselineType,imagingType,ledColor)
...
conv2um = 1e6;
[~,~,weightedcoeffHbT] = GetHbcoeffs_JNeurosci2023(ledType,bandfilterType,cutfilterType);
