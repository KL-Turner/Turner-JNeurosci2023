function [RestingBaselines] = CalculatePixelBaselines_JNeurosci2023(procDataFileIDs,RestingBaselines,baselineType)
...
for a = 1:length(restFileList)
    ...
    for b = 1:size(procDataFileIDs,1)
        ...
        [animalID,~,procDataFile] = GetFileInfo_JNeurosci2023(procDataFileID);
        if strcmp(fileID,procDataFile)
            ...
            [frames] = GetCBVFrameSubset_JNeurosci2023(windowCamFileID,imageHeight,imageWidth,frameInds);
            break
        end
    end
