function [figHandle,ax1,ax2,ax3,ax4,ax5,ax6] = GenerateSingleFigures_Turner2022(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType,hemoType)
