function [EventData] = ExtractEventTriggeredData_Turner2022(procdataFiles,dataTypes,imagingType)
...
for a = 1:length(dataTypes)
    ...
    for b = 1:size(procdataFiles,1)
        ...
        [animal,fileDate,fileID] = GetFileInfo_Turner2022(procdataFiles(b,:));
