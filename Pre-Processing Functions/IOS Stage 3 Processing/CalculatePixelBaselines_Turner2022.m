function [RestingBaselines] = CalculatePixelBaselines_Turner2022(procDataFileIDs,RestingBaselines,baselineType)
...
for a = 1:length(restFileList)
    ...
    for b = 1:size(procDataFileIDs,1)
        ...
        [animalID,~,procDataFile] = GetFileInfo_Turner2022(procDataFileID);
        if strcmp(fileID,procDataFile)
            ...
            [frames] = GetCBVFrameSubset_Turner2022(windowCamFileID,imageHeight,imageWidth,frameInds);
            break
        end
    end
