...
for ee = 1:size(procDataFileIDs,1)
    ...
    ConvertPupilAreaToDiameter_JNeurosci2023(procDataFileIDs(ee,:))
end
%% add pupil area to RestData.mat
dataTypes = {'pupilArea','diameter','mmArea','mmDiameter','patchCentroidX','patchCentroidY'};
ExtractPupilRestingData_JNeurosci2023(procDataFileIDs,dataTypes);
% add pupil baseline to Restingbaselines.mat
[RestingBaselines] = AddPupilRestingBaseline_JNeurosci2023();
%% zScore pupil data
for ff = 1:size(procDataFileIDs,1)
    ...
    zScorePupilData_JNeurosci2023(procDataFileID,RestingBaselines)
end
%% add pupil area to RestData.mat
...
[RestData] = ExtractPupilRestingData_JNeurosci2023(procDataFileIDs,dataTypes);
%% add pupil area to EventData.mat
[EventData] = ExtractPupilEventTriggeredData_JNeurosci2023(procDataFileIDs);
%% normalize Rest/Event data structures
[RestData] = NormBehavioralDataStruct_JNeurosci2023(RestData,RestingBaselines,'manualSelection');
save([animalID '_RestData.mat'],'RestData','-v7.3')
[EventData] = NormBehavioralDataStruct_JNeurosci2023(EventData,RestingBaselines,'manualSelection');
...
UpdatePupilSleepData_JNeurosci2023(procDataFileIDs)
