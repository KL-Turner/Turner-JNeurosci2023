function [] = PupilCoreProcessing_Turner2022()
...
%     zScorePupilData_Turner2022(procDataFileID,RestingBaselines)
% end
% %% add pupil area to RestData.mat
% dataTypes = {'pupilArea','diameter','mmArea','mmDiameter','zArea','zDiameter','LH_HbT','RH_HbT','LH_gammaBandPower','RH_gammaBandPower'};
% [RestData] = ExtractPupilRestingData_Turner2022(procDataFileIDs,dataTypes);
% %% add pupil area to EventData.mat
% [EventData] = ExtractPupilEventTriggeredData_Turner2022(procDataFileIDs);
% %% normalize Rest/Event data structures
% [RestData] = NormBehavioralDataStruct_Turner2022(RestData,RestingBaselines,'manualSelection');
