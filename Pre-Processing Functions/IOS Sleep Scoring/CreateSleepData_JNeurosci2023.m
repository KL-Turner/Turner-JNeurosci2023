function [SleepData] = CreateSleepData_JNeurosci2023(startingDirectory,trainingDirectory,baselineDirectory,NREMsleepTime,REMsleepTime,modelName,SleepData)
...
for aa = 1:size(procDataFileIDs,1) % loop through the list of ProcData files
    ...
    [~,~,fileID] = GetFileInfo_JNeurosci2023(procDataFileID); % gather file info
