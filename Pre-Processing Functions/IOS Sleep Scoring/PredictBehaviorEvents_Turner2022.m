function [ScoringResults] = PredictBehaviorEvents_Turner2022(animalID,startingDirectory,baselineDirectory,modelDataFileIDs,modelName)
...
if strcmp(notManual,'y') == true
    ...
    for e = 1:size(modelDataFileIDs,1)
        ...
        [~,~,fileID] = GetFileInfo_Turner2022(modelDataFileID);
        fileIDs{e,1} = fileID;
