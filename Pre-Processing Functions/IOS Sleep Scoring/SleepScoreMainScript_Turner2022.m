function [] = SleepScoreMainScript_Turner2022()
...
AddSleepParameters_Turner2022(procDataFileIDs,RestingBaselines,baselineType)
...
CreateTrainingDataSet_Turner2022(procDataFileIDs,RestingBaselines,baselineType)
...
[animalID] = TrainSleepModels_Turner2022;
...
for c = 1:length(modelNames)
    ...
    [ScoringResults] = PredictBehaviorEvents_Turner2022(animalID,startingDirectory,baselineDirectory,modelDataFileIDs,modelName);
    ApplySleepLogical_Turner2022(startingDirectory,trainingDirectory,baselineDirectory,modelName,ScoringResults)
    NREMsleepTime = 30; % seconds
    REMsleepTime = 60; % seconds
    [SleepData] = CreateSleepData_Turner2022(startingDirectory,trainingDirectory,baselineDirectory,NREMsleepTime,REMsleepTime,modelName,SleepData);
end
cd(baselineDirectory)
