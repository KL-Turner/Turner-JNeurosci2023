function [animalID] = TrainPupilSleepModels_JNeurosci2022()
...
% pull animal ID
[animalID,~,~] = GetFileInfo_JNeurosci2022(trainingTableFileID);
...
for ii = 1:size(oddReshapedREMindex,2)
    ...
    oddPatchedREMarray = LinkBinaryEvents_JNeurosci2022(oddREMArray',[5,0]);
...
for ii = 1:size(evenReshapedREMindex,2)
    ...
    evenPatchedREMarray = LinkBinaryEvents_JNeurosci2022(evenREMArray',[5,0]);
