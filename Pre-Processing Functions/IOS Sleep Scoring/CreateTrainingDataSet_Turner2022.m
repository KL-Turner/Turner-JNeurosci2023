function [] = CreateTrainingDataSet_Turner2022(procDataFileIDs,RestingBaselines,baselineType)
...
for a = 1:size(procDataFileIDs,1)
    ...
    if ~exist(trainingDataFileID,'file')
        ...
        hemoType = 'HbT';
        [figHandle,~,~,ax3,~,~,~] = GenerateSingleFigures_Turner2022(procDataFileID,RestingBaselines,baselineType,saveFigs,imagingType,hemoType);
        ...
        for b = 1:numBins
            ...
            [updatedGUI] = SelectBehavioralStateGUI_Turner2022;
            while buttonState == 0
                drawnow()
                if buttonState == 1
