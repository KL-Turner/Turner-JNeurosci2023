...
if runAnalysis == true
    ...
    AnalyzePupilMajorMinorAxisCorrelation_Handler_JNeurosci2022(rootFolder,delim,false)
    AnalyzeEyesOpenEyesClosedREM_Handler_JNeurosci2022(rootFolder,delim,false)
    AnalyzeTransitionalAverages_Handler_JNeurosci2022(rootFolder,delim,false)
    AnalyzeArousalStateEyeMotion_Handler_JNeurosci2022(rootFolder,delim,false)
    multiWaitbar('CloseAll');
    cd(rootFolder)
end
% Main figures
...
Fig7_JNeurosci2022(rootFolder,saveFigs,delim)
