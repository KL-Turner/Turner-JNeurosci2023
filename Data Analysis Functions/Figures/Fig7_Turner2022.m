function [AnalysisResults] = Fig7_Turner2022(rootFolder,saveFigs,delim,AnalysisResults)
...
[pupilPred] = FilterIndexREM_Manuscript2022(pupilPred,dataLength);
...
[physioPred] = FilterIndexREM_Manuscript2022(physioPred,dataLength);
...
[combinedPred] = FilterIndexREM_Manuscript2022(combinedPred,dataLength);
...
for qq = 1:length(Results_Example.allPhysioTables)
    ...
    [allPupilPred] = FilterIndexREM_Manuscript2022(allPupilPred,dataLength);
    % physio MDL
    ...
    [allPhysioPred] = FilterIndexREM_Manuscript2022(allPhysioPred,dataLength);
    % combined MDL
    ...
    [allCombinedPred] = FilterIndexREM_Manuscript2022(allCombinedPred,dataLength);
...
if saveFigs == true
    ...
    savefig(Fig7C,[dirpath 'Fig7C_Turner2022']);
    set(Fig7C,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7C_Turner2022'])
end
%% example trial
...
if saveFigs == true
    ...
    savefig(Fig7B,[dirpath 'Fig7B_Turner2022']);
    set(Fig7B,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7B_Turner2022'])
end
...
if saveFigs == true
    ...
    savefig(Fig7A,[dirpath 'Fig7A_Turner2022']);
    set(Fig7A,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7A_Turner2022'])
    % text diary
