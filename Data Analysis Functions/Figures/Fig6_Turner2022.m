function [AnalysisResults] = Fig6_Turner2022(rootFolder,saveFigs,delim,AnalysisResults)
...
if saveFigs == true
    ...
    savefig(Fig6C,[dirpath 'Fig6C_Turner2022']);
    set(Fig6C,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig6C_Turner2022'])
end
%% example trial
...
if saveFigs == true
    ...
    savefig(Fig6B,[dirpath 'Fig6B_Turner2022']);
    set(Fig6B,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig6B_Turner2022'])
end
...
if saveFigs == true
    ...
    savefig(Fig6A,[dirpath 'Fig6D_Turner2022']);
    set(Fig6A,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig6A_Turner2022'])
    % text diary
