function [] = Fig5_JNeurosci2023(rootFolder,saveFigs,delim)
...
Fig5 =  figure('Name','Figure Panel 5 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
...
if saveFigs == true
    ...
    savefig(Fig5,[dirpath 'Fig5_JNeurosci2023']);
    set(Fig5,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig5_JNeurosci2023'])
    % text diary
