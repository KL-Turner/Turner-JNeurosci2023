function [] = Fig2_JNeurosci2023(rootFolder,saveFigs,delim)
...
mmDiameterStatsA = fitglme(mmDiameterTable,mmDiameterFitFormula);

mmDiameterTableSize = cat(1,data.Diameter.Whisk.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterTable = table('Size',[size(mmDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','mmDiameter'});
mmDiameterTable.Mouse = cat(1,data.Diameter.Whisk.animalID,data.Diameter.Rest.animalID,data.Diameter.Stim.animalID,data.Diameter.NREM.animalID,data.Diameter.REM.animalID);
mmDiameterTable.Behavior = cat(1,data.Diameter.Whisk.behavField,data.Diameter.Rest.behavField,data.Diameter.Stim.behavField,data.Diameter.NREM.behavField,data.Diameter.REM.behavField);
mmDiameterTable.mmDiameter = cat(1,data.Diameter.Whisk.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterFitFormula = 'mmDiameter ~ 1 + Behavior + (1|Mouse)';
mmDiameterStatsB = fitglme(mmDiameterTable,mmDiameterFitFormula);

mmDiameterTableSize = cat(1,data.Diameter.Stim.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterTable = table('Size',[size(mmDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','mmDiameter'});
mmDiameterTable.Mouse = cat(1,data.Diameter.Stim.animalID,data.Diameter.Whisk.animalID,data.Diameter.Rest.animalID,data.Diameter.NREM.animalID,data.Diameter.REM.animalID);
mmDiameterTable.Behavior = cat(1,data.Diameter.Stim.behavField,data.Diameter.Whisk.behavField,data.Diameter.Rest.behavField,data.Diameter.NREM.behavField,data.Diameter.REM.behavField);
mmDiameterTable.mmDiameter = cat(1,data.Diameter.Stim.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterFitFormula = 'mmDiameter ~ 1 + Behavior + (1|Mouse)';
mmDiameterStatsC = fitglme(mmDiameterTable,mmDiameterFitFormula);

mmDiameterTableSize = cat(1,data.Diameter.NREM.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterTable = table('Size',[size(mmDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','mmDiameter'});
mmDiameterTable.Mouse = cat(1,data.Diameter.NREM.animalID,data.Diameter.Whisk.animalID,data.Diameter.Stim.animalID,data.Diameter.Rest.animalID,data.Diameter.REM.animalID);
mmDiameterTable.Behavior = cat(1,data.Diameter.NREM.behavField,data.Diameter.Whisk.behavField,data.Diameter.Stim.behavField,data.Diameter.Rest.behavField,data.Diameter.REM.behavField);
mmDiameterTable.mmDiameter = cat(1,data.Diameter.NREM.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.Rest.mmDiameter,data.Diameter.REM.mmDiameter);
mmDiameterFitFormula = 'mmDiameter ~ 1 + Behavior + (1|Mouse)';
mmDiameterStatsD = fitglme(mmDiameterTable,mmDiameterFitFormula);

mmDiameterTableSize = cat(1,data.Diameter.REM.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.Rest.mmDiameter);
mmDiameterTable = table('Size',[size(mmDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','mmDiameter'});
mmDiameterTable.Mouse = cat(1,data.Diameter.REM.animalID,data.Diameter.Whisk.animalID,data.Diameter.Stim.animalID,data.Diameter.NREM.animalID,data.Diameter.Rest.animalID);
mmDiameterTable.Behavior = cat(1,data.Diameter.REM.behavField,data.Diameter.Whisk.behavField,data.Diameter.Stim.behavField,data.Diameter.NREM.behavField,data.Diameter.Rest.behavField);
mmDiameterTable.mmDiameter = cat(1,data.Diameter.REM.mmDiameter,data.Diameter.Whisk.mmDiameter,data.Diameter.Stim.mmDiameter,data.Diameter.NREM.mmDiameter,data.Diameter.Rest.mmDiameter);
mmDiameterFitFormula = 'mmDiameter ~ 1 + Behavior + (1|Mouse)';
mmDiameterStatsE = fitglme(mmDiameterTable,mmDiameterFitFormula);
...
zDiameterStatsA = fitglme(zDiameterTable,zDiameterFitFormula);

zDiameterTableSize = cat(1,data.Diameter.Whisk.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.REM.zDiameter);
zDiameterTable = table('Size',[size(zDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','zDiameter'});
zDiameterTable.Mouse = cat(1,data.Diameter.Whisk.animalID,data.Diameter.Rest.animalID,data.Diameter.Stim.animalID,data.Diameter.NREM.animalID,data.Diameter.REM.animalID);
zDiameterTable.Behavior = cat(1,data.Diameter.Whisk.behavField,data.Diameter.Rest.behavField,data.Diameter.Stim.behavField,data.Diameter.NREM.behavField,data.Diameter.REM.behavField);
zDiameterTable.zDiameter = cat(1,data.Diameter.Whisk.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.REM.zDiameter);
zDiameterFitFormula = 'zDiameter ~ 1 + Behavior + (1|Mouse)';
zDiameterStatsB = fitglme(zDiameterTable,zDiameterFitFormula);

zDiameterTableSize = cat(1,data.Diameter.Stim.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.REM.zDiameter);
zDiameterTable = table('Size',[size(zDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','zDiameter'});
zDiameterTable.Mouse = cat(1,data.Diameter.Stim.animalID,data.Diameter.Whisk.animalID,data.Diameter.Rest.animalID,data.Diameter.NREM.animalID,data.Diameter.REM.animalID);
zDiameterTable.Behavior = cat(1,data.Diameter.Stim.behavField,data.Diameter.Whisk.behavField,data.Diameter.Rest.behavField,data.Diameter.NREM.behavField,data.Diameter.REM.behavField);
zDiameterTable.zDiameter = cat(1,data.Diameter.Stim.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.REM.zDiameter);
zDiameterFitFormula = 'zDiameter ~ 1 + Behavior + (1|Mouse)';
zDiameterStatsC = fitglme(zDiameterTable,zDiameterFitFormula);

zDiameterTableSize = cat(1,data.Diameter.NREM.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.REM.zDiameter);
zDiameterTable = table('Size',[size(zDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','zDiameter'});
zDiameterTable.Mouse = cat(1,data.Diameter.NREM.animalID,data.Diameter.Whisk.animalID,data.Diameter.Stim.animalID,data.Diameter.Rest.animalID,data.Diameter.REM.animalID);
zDiameterTable.Behavior = cat(1,data.Diameter.NREM.behavField,data.Diameter.Whisk.behavField,data.Diameter.Stim.behavField,data.Diameter.Rest.behavField,data.Diameter.REM.behavField);
zDiameterTable.zDiameter = cat(1,data.Diameter.NREM.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.Rest.zDiameter,data.Diameter.REM.zDiameter);
zDiameterFitFormula = 'zDiameter ~ 1 + Behavior + (1|Mouse)';
zDiameterStatsD = fitglme(zDiameterTable,zDiameterFitFormula);

zDiameterTableSize = cat(1,data.Diameter.REM.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.Rest.zDiameter);
zDiameterTable = table('Size',[size(zDiameterTableSize,1),3],'VariableTypes',{'string','string','double'},'VariableNames',{'Mouse','Behavior','zDiameter'});
zDiameterTable.Mouse = cat(1,data.Diameter.REM.animalID,data.Diameter.Whisk.animalID,data.Diameter.Stim.animalID,data.Diameter.NREM.animalID,data.Diameter.Rest.animalID);
zDiameterTable.Behavior = cat(1,data.Diameter.REM.behavField,data.Diameter.Whisk.behavField,data.Diameter.Stim.behavField,data.Diameter.NREM.behavField,data.Diameter.Rest.behavField);
zDiameterTable.zDiameter = cat(1,data.Diameter.REM.zDiameter,data.Diameter.Whisk.zDiameter,data.Diameter.Stim.zDiameter,data.Diameter.NREM.zDiameter,data.Diameter.Rest.zDiameter);
zDiameterFitFormula = 'zDiameter ~ 1 + Behavior + (1|Mouse)';
zDiameterStatsE = fitglme(zDiameterTable,zDiameterFitFormula);
...
%% figures
Fig2 = figure('Name','Figure Panel 2 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
%% mm pupil diameter during arousal states
ax2 = subplot(1,4,1);
s1 = scatter(ones(1,length(data.Diameter.Rest.mmDiameter))*1,data.Diameter.Rest.mmDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom rest'),'jitter','on','jitterAmount',0);
hold on
e1 = errorbar(1,data.Diameter.Rest.meanDiameter,data.Diameter.Rest.stdDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;
s2 = scatter(ones(1,length(data.Diameter.Whisk.mmDiameter))*2,data.Diameter.Whisk.mmDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom whisk'),'jitter','on','jitterAmount',0);
e2 = errorbar(2,data.Diameter.Whisk.meanDiameter,data.Diameter.Whisk.stdDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 10;
e2.CapSize = 10;
s3 = scatter(ones(1,length(data.Diameter.Stim.mmDiameter))*3,data.Diameter.Stim.mmDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom stim'),'jitter','on','jitterAmount',0);
e3 = errorbar(3,data.Diameter.Stim.meanDiameter,data.Diameter.Stim.stdDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e3.Color = 'black';
e3.MarkerSize = 10;
e3.CapSize = 10;
s4 = scatter(ones(1,length(data.Diameter.NREM.mmDiameter))*4,data.Diameter.NREM.mmDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom nrem'),'jitter','on','jitterAmount',0);
e4 = errorbar(4,data.Diameter.NREM.meanDiameter,data.Diameter.NREM.stdDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 10;
e4.CapSize = 10;
s5 = scatter(ones(1,length(data.Diameter.REM.mmDiameter))*5,data.Diameter.REM.mmDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom rem'),'jitter','on','jitterAmount',0);
...
ax3 = subplot(1,4,2);
scatter(ones(1,length(data.Diameter.Rest.zDiameter))*1,data.Diameter.Rest.zDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom rest'),'jitter','on','jitterAmount',0);
hold on
e1 = errorbar(1,data.Diameter.Rest.meanzDiameter,data.Diameter.Rest.stdzDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 10;
e1.CapSize = 10;
scatter(ones(1,length(data.Diameter.Whisk.zDiameter))*2,data.Diameter.Whisk.zDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom whisk'),'jitter','on','jitterAmount',0);
e2 = errorbar(2,data.Diameter.Whisk.meanzDiameter,data.Diameter.Whisk.stdzDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 10;
e2.CapSize = 10;
scatter(ones(1,length(data.Diameter.Stim.zDiameter))*3,data.Diameter.Stim.zDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom stim'),'jitter','on','jitterAmount',0);
e3 = errorbar(3,data.Diameter.Stim.meanzDiameter,data.Diameter.Stim.stdzDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e3.Color = 'black';
e3.MarkerSize = 10;
e3.CapSize = 10;
scatter(ones(1,length(data.Diameter.NREM.zDiameter))*4,data.Diameter.NREM.zDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom nrem'),'jitter','on','jitterAmount',0);
e4 = errorbar(4,data.Diameter.NREM.meanzDiameter,data.Diameter.NREM.stdzDiameter,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 10;
e4.CapSize = 10;
scatter(ones(1,length(data.Diameter.REM.zDiameter))*5,data.Diameter.REM.zDiameter,75,'MarkerEdgeColor','k','MarkerFaceColor',colors('custom rem'),'jitter','on','jitterAmount',0);
...
if saveFigs == true
    ...
    savefig(Fig2,[dirpath 'Fig2_JNeurosci2023']);
    set(Fig2,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig2_JNeurosci2023'])
    % text diary
    ...
    disp('======================================================================================================================')
    disp(zDiameterStatsA)
    disp(zDiameterStatsB)
    disp(zDiameterStatsC)
    disp(zDiameterStatsD)
    disp(zDiameterStatsE)
    disp('----------------------------------------------------------------------------------------------------------------------')
