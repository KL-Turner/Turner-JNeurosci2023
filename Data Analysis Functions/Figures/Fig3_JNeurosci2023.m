function [] = Fig3_JNeurosci2023(rootFolder,saveFigs,delim)
...
if saveFigs == true
    ...
    Fig3A = figure('Name','Figure Panel 3 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
    subplot(1,2,1)
    ...
    savefig(Fig3A,[dirpath 'Fig3A_JNeurosci2023']);
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig3A_JNeurosci2023'])
    close(Fig3A)
    imwrite(h1Img,[dirpath 'Fig3_HbTAwake_JNeurosci2023.png'])
    imwrite(h2Img,[dirpath 'Fig3_HbTNREM_JNeurosci2023.png'])
    imwrite(h3Img,[dirpath 'Fig3_HbTREM_JNeurosci2023.png'])
    imwrite(h4Img,[dirpath 'Fig3_GammaAwake_JNeurosci2023.png'])
    imwrite(h5Img,[dirpath 'Fig3_GammaNREM_JNeurosci2023.png'])
    imwrite(h6Img,[dirpath 'Fig3_GammaREM_JNeurosci2023.png'])
end
...
HbTC002StatsA = fitglme(HbTC002Table,HbTC002FitFormula);

HbTC002TableSize = cat(1,data.Coherr.Asleep.zDiameter.HbTC002,data.Coherr.Alert.zDiameter.HbTC002,data.Coherr.All.zDiameter.HbTC002);
HbTC002Table = table('Size',[size(HbTC002TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC002'});
HbTC002Table.Mouse = cat(1,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
HbTC002Table.Behavior = cat(1,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
HbTC002Table.Hemisphere = cat(1,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
HbTC002Table.HbTC002 = cat(1,data.Coherr.Asleep.zDiameter.HbTC002,data.Coherr.Alert.zDiameter.HbTC002,data.Coherr.All.zDiameter.HbTC002);
HbTC002FitFormula = 'HbTC002 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC002StatsB = fitglme(HbTC002Table,HbTC002FitFormula);

HbTC002TableSize = cat(1,data.Coherr.All.zDiameter.HbTC002,data.Coherr.Asleep.zDiameter.HbTC002,data.Coherr.Alert.zDiameter.HbTC002);
HbTC002Table = table('Size',[size(HbTC002TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC002'});
HbTC002Table.Mouse = cat(1,data.Coherr.All.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID);
HbTC002Table.Behavior = cat(1,data.Coherr.All.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField);
HbTC002Table.Hemisphere = cat(1,data.Coherr.All.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere);
HbTC002Table.HbTC002 = cat(1,data.Coherr.All.zDiameter.HbTC002,data.Coherr.Asleep.zDiameter.HbTC002,data.Coherr.Alert.zDiameter.HbTC002);
HbTC002FitFormula = 'HbTC002 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC002StatsC = fitglme(HbTC002Table,HbTC002FitFormula);
...
gammaC002StatsA = fitglme(gammaC002Table,gammaC002FitFormula);

gammaC002TableSize = cat(1,data.Coherr.Asleep.zDiameter.gammaC002,data.Coherr.Alert.zDiameter.gammaC002,data.Coherr.All.zDiameter.gammaC002);
gammaC002Table = table('Size',[size(gammaC002TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC002'});
gammaC002Table.Mouse = cat(1,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
gammaC002Table.Behavior = cat(1,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
gammaC002Table.Hemisphere = cat(1,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
gammaC002Table.gammaC002 = cat(1,data.Coherr.Asleep.zDiameter.gammaC002,data.Coherr.Alert.zDiameter.gammaC002,data.Coherr.All.zDiameter.gammaC002);
gammaC002FitFormula = 'gammaC002 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC002StatsB = fitglme(gammaC002Table,gammaC002FitFormula);

gammaC002TableSize = cat(1,data.Coherr.All.zDiameter.gammaC002,data.Coherr.Asleep.zDiameter.gammaC002,data.Coherr.Alert.zDiameter.gammaC002);
gammaC002Table = table('Size',[size(gammaC002TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC002'});
gammaC002Table.Mouse = cat(1,data.Coherr.All.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID);
gammaC002Table.Behavior = cat(1,data.Coherr.All.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField);
gammaC002Table.Hemisphere = cat(1,data.Coherr.All.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere);
gammaC002Table.gammaC002 = cat(1,data.Coherr.All.zDiameter.gammaC002,data.Coherr.Asleep.zDiameter.gammaC002,data.Coherr.Alert.zDiameter.gammaC002);
gammaC002FitFormula = 'gammaC002 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC002StatsC = fitglme(gammaC002Table,gammaC002FitFormula);
...
HbTC035Table.Hemisphere = cat(1,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
...
HbTC035StatsA = fitglme(HbTC035Table,HbTC035FitFormula);

HbTC035TableSize = cat(1,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035Table = table('Size',[size(HbTC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC035'});
HbTC035Table.Mouse = cat(1,data.Coherr.NREM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
HbTC035Table.Behavior = cat(1,data.Coherr.NREM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
HbTC035Table.Hemisphere = cat(1,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
HbTC035Table.HbTC035 = cat(1,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035FitFormula = 'HbTC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC035StatsB = fitglme(HbTC035Table,HbTC035FitFormula);

HbTC035TableSize = cat(1,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035Table = table('Size',[size(HbTC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC035'});
HbTC035Table.Mouse = cat(1,data.Coherr.REM.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
HbTC035Table.Behavior = cat(1,data.Coherr.REM.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
HbTC035Table.Hemisphere = cat(1,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
HbTC035Table.HbTC035 = cat(1,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035FitFormula = 'HbTC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC035StatsC = fitglme(HbTC035Table,HbTC035FitFormula);

HbTC035TableSize = cat(1,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035Table = table('Size',[size(HbTC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC035'});
HbTC035Table.Mouse = cat(1,data.Coherr.Alert.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
HbTC035Table.Behavior = cat(1,data.Coherr.Alert.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
HbTC035Table.Hemisphere = cat(1,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
HbTC035Table.HbTC035 = cat(1,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035FitFormula = 'HbTC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC035StatsD = fitglme(HbTC035Table,HbTC035FitFormula);

HbTC035TableSize = cat(1,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035Table = table('Size',[size(HbTC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC035'});
HbTC035Table.Mouse = cat(1,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
HbTC035Table.Behavior = cat(1,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
HbTC035Table.Hemisphere = cat(1,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
HbTC035Table.HbTC035 = cat(1,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035,data.Coherr.All.zDiameter.HbTC035);
HbTC035FitFormula = 'HbTC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC035StatsE = fitglme(HbTC035Table,HbTC035FitFormula);

HbTC035TableSize = cat(1,data.Coherr.All.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035);
HbTC035Table = table('Size',[size(HbTC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','HbTC035'});
HbTC035Table.Mouse = cat(1,data.Coherr.All.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID);
HbTC035Table.Behavior = cat(1,data.Coherr.All.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField);
HbTC035Table.Hemisphere = cat(1,data.Coherr.All.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere);
HbTC035Table.HbTC035 = cat(1,data.Coherr.All.zDiameter.HbTC035,data.Coherr.NREM.zDiameter.HbTC035,data.Coherr.REM.zDiameter.HbTC035,data.Coherr.Alert.zDiameter.HbTC035,data.Coherr.Asleep.zDiameter.HbTC035,data.Coherr.Rest.zDiameter.HbTC035);
HbTC035FitFormula = 'HbTC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
HbTC035StatsF = fitglme(HbTC035Table,HbTC035FitFormula);
...
gammaC035Table.Hemisphere = cat(1,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
...
gammaC035StatsA = fitglme(gammaC035Table,gammaC035FitFormula);

gammaC035TableSize = cat(1,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035Table = table('Size',[size(gammaC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC035'});
gammaC035Table.Mouse = cat(1,data.Coherr.NREM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
gammaC035Table.Behavior = cat(1,data.Coherr.NREM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
gammaC035Table.Hemisphere = cat(1,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
gammaC035Table.gammaC035 = cat(1,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035FitFormula = 'gammaC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC035StatsB = fitglme(gammaC035Table,gammaC035FitFormula);

gammaC035TableSize = cat(1,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035Table = table('Size',[size(gammaC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC035'});
gammaC035Table.Mouse = cat(1,data.Coherr.REM.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
gammaC035Table.Behavior = cat(1,data.Coherr.REM.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
gammaC035Table.Hemisphere = cat(1,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
gammaC035Table.gammaC035 = cat(1,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035FitFormula = 'gammaC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC035StatsC = fitglme(gammaC035Table,gammaC035FitFormula);

gammaC035TableSize = cat(1,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035Table = table('Size',[size(gammaC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC035'});
gammaC035Table.Mouse = cat(1,data.Coherr.Alert.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
gammaC035Table.Behavior = cat(1,data.Coherr.Alert.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
gammaC035Table.Hemisphere = cat(1,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
gammaC035Table.gammaC035 = cat(1,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035FitFormula = 'gammaC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC035StatsD = fitglme(gammaC035Table,gammaC035FitFormula);

gammaC035TableSize = cat(1,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035Table = table('Size',[size(gammaC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC035'});
gammaC035Table.Mouse = cat(1,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID,data.Coherr.All.zDiameter.animalID);
gammaC035Table.Behavior = cat(1,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField,data.Coherr.All.zDiameter.behavField);
gammaC035Table.Hemisphere = cat(1,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere,data.Coherr.All.zDiameter.hemisphere);
gammaC035Table.gammaC035 = cat(1,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035,data.Coherr.All.zDiameter.gammaC035);
gammaC035FitFormula = 'gammaC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC035StatsE = fitglme(gammaC035Table,gammaC035FitFormula);

gammaC035TableSize = cat(1,data.Coherr.All.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035);
gammaC035Table = table('Size',[size(gammaC035TableSize,1),4],'VariableTypes',{'string','string','string','double'},'VariableNames',{'Mouse','Behavior','Hemisphere','gammaC035'});
gammaC035Table.Mouse = cat(1,data.Coherr.All.zDiameter.animalID,data.Coherr.NREM.zDiameter.animalID,data.Coherr.REM.zDiameter.animalID,data.Coherr.Alert.zDiameter.animalID,data.Coherr.Asleep.zDiameter.animalID,data.Coherr.Rest.zDiameter.animalID);
gammaC035Table.Behavior = cat(1,data.Coherr.All.zDiameter.behavField,data.Coherr.NREM.zDiameter.behavField,data.Coherr.REM.zDiameter.behavField,data.Coherr.Alert.zDiameter.behavField,data.Coherr.Asleep.zDiameter.behavField,data.Coherr.Rest.zDiameter.behavField);
gammaC035Table.Hemisphere = cat(1,data.Coherr.All.zDiameter.hemisphere,data.Coherr.NREM.zDiameter.hemisphere,data.Coherr.REM.zDiameter.hemisphere,data.Coherr.Alert.zDiameter.hemisphere,data.Coherr.Asleep.zDiameter.hemisphere,data.Coherr.Rest.zDiameter.hemisphere);
gammaC035Table.gammaC035 = cat(1,data.Coherr.All.zDiameter.gammaC035,data.Coherr.NREM.zDiameter.gammaC035,data.Coherr.REM.zDiameter.gammaC035,data.Coherr.Alert.zDiameter.gammaC035,data.Coherr.Asleep.zDiameter.gammaC035,data.Coherr.Rest.zDiameter.gammaC035);
gammaC035FitFormula = 'gammaC035 ~ 1 + Behavior + (1|Mouse) + (1|Mouse:Hemisphere)';
gammaC035StatsF = fitglme(gammaC035Table,gammaC035FitFormula);
...
%% figures
Fig3 = figure('Name','Figure Panel 3 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
%% Gamma
subplot(4,3,1)
...
if saveFigs == true
    ...
    savefig(Fig3,[dirpath 'Fig3_JNeurosci2023']);
    set(Fig3,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig3_JNeurosci2023'])
    % text diary
    ...
    disp('======================================================================================================================')
    disp(gammaC035StatsA)
    disp(gammaC035StatsB)
    disp(gammaC035StatsC)
    disp(gammaC035StatsD)
    disp(gammaC035StatsE)
    disp(gammaC035StatsF)
    disp('----------------------------------------------------------------------------------------------------------------------')
    ...
    disp('======================================================================================================================')
    disp(gammaC002StatsA)
    disp(gammaC002StatsB)
    disp(gammaC002StatsC)
    disp('----------------------------------------------------------------------------------------------------------------------')
