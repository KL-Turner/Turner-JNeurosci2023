function [AnalysisResults] = Fig7_JNeurosci2023(rootFolder,saveFigs,delim,AnalysisResults)
...
[pupilPred] = FilterIndexREM_JNeurosci2023(pupilPred,dataLength);
...
[physioPred] = FilterIndexREM_JNeurosci2023(physioPred,dataLength);
...
[combinedPred] = FilterIndexREM_JNeurosci2023(combinedPred,dataLength);
...
for qq = 1:length(Results_Example.allPhysioTables)
    ...
    [allPupilPred] = FilterIndexREM_JNeurosci2023(allPupilPred,dataLength);
    % physio MDL
    ...
    [allPhysioPred] = FilterIndexREM_JNeurosci2023(allPhysioPred,dataLength);
    % combined MDL
    ...
    [allCombinedPred] = FilterIndexREM_JNeurosci2023(allCombinedPred,dataLength);
...
%% Figure panel 7
Fig7C = figure('Name','Figure Panel 7 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
...
if saveFigs == true
    ...
    savefig(Fig7C,[dirpath 'Fig7C_JNeurosci2023']);
    set(Fig7C,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7C_JNeurosci2023'])
end
%% example trial
Fig7B =  figure('Name','Figure Panel 7 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
...
if saveFigs == true
    ...
    savefig(Fig7B,[dirpath 'Fig7B_JNeurosci2023']);
    set(Fig7B,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7B_JNeurosci2023'])
end
%% hypnogram for model comparison
Fig7A = figure('Name','Figure Panel 7 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
subplot(4,1,1)
...
if saveFigs == true
    ...
    savefig(Fig7A,[dirpath 'Fig7A_JNeurosci2023']);
    set(Fig7A,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig7A_JNeurosci2023'])
    % text diary
