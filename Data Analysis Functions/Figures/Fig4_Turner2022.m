...
if saveFigs == true
    ...
    savefig(Fig4A,[dirpath 'Fig4A_Turner2022']);
    set(Fig4A,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4A_Turner2022'])
end
...
if saveFigs == true
    ...
    savefig(Fig4B,[dirpath 'Fig4B_Turner2022']);
    set(Fig4B,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4B_Turner2022'])
end
...
if saveFigs == true
    ...
    savefig(Fig4C,[dirpath 'Fig4C_Turner2022']);
    set(Fig4C,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4C_Turner2022'])
    % text diary
