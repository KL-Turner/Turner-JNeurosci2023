...
if saveFigs == true
    ...
    savefig(Fig4A,[dirpath 'Fig4A_JNeurosci2022']);
    set(Fig4A,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4A_JNeurosci2022'])
end
%% awake blink triggered averages
Fig4B = figure('Name','Figure Panel 4 - Turner et al. 2022','Units','Normalized','OuterPosition',[0,0,1,1]);
...
if saveFigs == true
    ...
    savefig(Fig4B,[dirpath 'Fig4B_JNeurosci2022']);
    set(Fig4B,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4B_JNeurosci2022'])
end
%% asleep blink triggered averages
Fig4C = figure('Name','Figure Panel 4 - Turner et al. 2022','Units','Normalized','OuterPosition',[0,0,1,1]);
...
if saveFigs == true
    ...
    savefig(Fig4C,[dirpath 'Fig4C_JNeurosci2022']);
    set(Fig4C,'PaperPositionMode','auto');
    print('-vector','-dpdf','-bestfit',[dirpath 'Fig4C_JNeurosci2022'])
    % text diary
