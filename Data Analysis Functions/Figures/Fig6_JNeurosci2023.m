function [AnalysisResults] = Fig6_JNeurosci2023(rootFolder,saveFigs,delim,AnalysisResults)
...
%% Figure
Fig6 = figure('Name','Figure Panel 6 - Turner et al. 2023','Units','Normalized','OuterPosition',[0,0,1,1]);
ax1 = subplot(3,4,1:2);
edges = -8:0.1:6.5;
yyaxis right
...
if saveFigs == true
    ...
    savefig(Fig6,[dirpath 'Fig6B_JNeurosci2023']);
    set(Fig6,'PaperPositionMode','auto');
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig6B_JNeurosci2023'])
    % text diary
