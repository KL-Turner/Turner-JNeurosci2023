...
if saveFigs == true
    ...
    print('-vector','-dpdf','-fillpage',[dirpath 'Fig3A_JNeurosci2022'])
    close(Fig3A)
    imwrite(h1Img,[dirpath 'Fig3_HbTAwake_JNeurosci2022.png'])
    imwrite(h2Img,[dirpath 'Fig3_HbTNREM_JNeurosci2022.png'])
    imwrite(h3Img,[dirpath 'Fig3_HbTREM_JNeurosci2022.png'])
    imwrite(h4Img,[dirpath 'Fig3_GammaAwake_JNeurosci2022.png'])
    imwrite(h5Img,[dirpath 'Fig3_GammaNREM_JNeurosci2022.png'])
    imwrite(h6Img,[dirpath 'Fig3_GammaREM_JNeurosci2022.png'])
end
