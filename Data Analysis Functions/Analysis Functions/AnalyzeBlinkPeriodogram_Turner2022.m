function [Results_BlinkPeriodogram] = AnalyzeBlinkPeriodogram_Turner2022(animalID,rootFolder,delim,Results_BlinkPeriodogram)
...
[~,dateList,~] = GetFileInfo_Turner2022(procDataFileIDs);
[uniqueDays,dayIndex] = GetUniqueDays_Turner2022(dateList);
...
for aa = 1:length(uniqueDays)
    uniqueDay = ConvertDate_Turner2022(uniqueDays{aa,1});
...
for bb = 1:size(dayProcDataFileIDs,1)
    uniqueDay = ConvertDate_Turner2022(uniqueDays{bb,1});
