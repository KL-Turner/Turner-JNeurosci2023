function [] = AnalyzePupilSleepModelAccuracy_Handler_JNeurosci2023(rootFolder,delim,runFromStart)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% Purpose: Handler function for AnalyzePhysioSleepModelAccuracy_JNeurosci2023.mat
%________________________________________________________________________________________________________________________
...
for bb = 1:length(animalIDs)
    if isfield(Results_PupilSleepModel,(animalIDs{1,bb})) == false
        [Results_PupilSleepModel] = AnalyzePupilSleepModelAccuracy_JNeurosci2023(animalIDs{1,bb},rootFolder,delim,Results_PupilSleepModel);
    end
