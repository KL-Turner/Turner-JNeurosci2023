function [] = AnalyzeBlinkPeriodogram_Handler_JNeurosci2022(rootFolder,delim,runFromStart)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% Purpose: Handler function for AnalyzeBlinkPeriodogram_JNeurosci2022.mat
%________________________________________________________________________________________________________________________
...
for bb = 1:length(animalIDs)
    if isfield(Results_BlinkPeriodogram,(animalIDs{1,bb})) == false
        [Results_BlinkPeriodogram] = AnalyzeBlinkPeriodogram_JNeurosci2022(animalIDs{1,bb},rootFolder,delim,Results_BlinkPeriodogram);
    end
