function [] = AnalyzeBehavioralArea_Handler_Turner2022(rootFolder,delim,runFromStart)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% Purpose: Handler function for AnalyzeBehavioralArea_Turner2022.mat
%________________________________________________________________________________________________________________________
...
for bb = 1:length(animalIDs)
    if isfield(Results_BehavData,(animalIDs{1,bb})) == false
        [Results_BehavData] = AnalyzeBehavioralArea_Turner2022(animalIDs{1,bb},rootFolder,delim,Results_BehavData);
    end
