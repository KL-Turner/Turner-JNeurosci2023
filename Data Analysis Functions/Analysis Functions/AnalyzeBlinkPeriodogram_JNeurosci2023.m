function [Results_BlinkPeriodogram] = AnalyzeBlinkPeriodogram_JNeurosci2023(animalID,rootFolder,delim,Results_BlinkPeriodogram)
...
[~,dateList,~] = GetFileInfo_JNeurosci2023(procDataFileIDs);
[uniqueDays,dayIndex] = GetUniqueDays_JNeurosci2023(dateList);
...
for aa = 1:length(uniqueDays)
    uniqueDay = ConvertDate_JNeurosci2023(uniqueDays{aa,1});
...
for bb = 1:size(dayProcDataFileIDs,1)
    uniqueDay = ConvertDate_JNeurosci2023(uniqueDays{bb,1});
