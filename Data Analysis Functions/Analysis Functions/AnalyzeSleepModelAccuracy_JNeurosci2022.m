function [Results_PupilSleepModel,Results_PhysioSleepModel,Results_CombinedSleepModel] = AnalyzeSleepModelAccuracy_JNeurosci2022(animalID,rootFolder,delim,Results_PupilSleepModel,Results_PhysioSleepModel,Results_CombinedSleepModel)
...
CreatePupilModelDataSet_JNeurosci2022(procDataFileIDs)
UpdatePupilTrainingDataSet_JNeurosci2022(procDataFileIDs)
% prepare physio training data by updating parameters
AddSleepParameters_JNeurosci2022(procDataFileIDs,RestingBaselines,'manualSelection')
