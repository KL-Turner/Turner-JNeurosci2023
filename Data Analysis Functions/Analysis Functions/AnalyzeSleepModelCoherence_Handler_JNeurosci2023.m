function [] = AnalyzeSleepModelCoherence_Handler_JNeurosci2023(~,~,runFromStart)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% Purpose: Handler function for AnalyzePupilModelCoherence_JNeurosci2023.mat
%________________________________________________________________________________________________________________________
...
for bb = 1:length(animalIDs)
    if isfield(Results_PupilModelCoherence,(animalIDs{1,bb})) == false
        [Results_PupilModelCoherence] = AnalyzeSleepModelCoherence_JNeurosci2023(animalIDs{1,bb},Results_PupilModelCoherence);
    end
